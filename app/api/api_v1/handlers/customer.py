...
async def retrieve(phone_number: str, current_user: User = Depends(get_current_user)):
    return await CustomerService.retrieve_customer2(current_user, phone_number)
