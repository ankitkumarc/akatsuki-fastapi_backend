...
class CustomerService:
    ...
    @staticmethod
    async def retrieve_customer2(current_user:User, phone_number:str):
        customer = await Customer.find_one(Customer.phone_number == phone_number, Customer.owner.id == current_user.id)
        return customer
